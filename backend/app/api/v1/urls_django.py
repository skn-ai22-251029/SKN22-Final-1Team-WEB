...
urlpatterns = [
    ...
    path('analysis/report/', AdminTrendReportView.as_view(), name='trend-report'),
    path('analysis/consult/', ConsultView.as_view(), name='consult'),
    path('customers/', AllClientsView.as_view(), name='customer-list'),
    path('customers/<int:pk>/', AdminClientDetailView.as_view(), name='customer-detail'),
